...
public:
    ...
    virtual bool IsTouchScreenReady() const wxOVERRIDE;
    virtual bool EnableRawTouchEvent() wxOVERRIDE;
    virtual bool HasTouchEvent() const wxOVERRIDE
    {
        return m_hasTouchEvent;
    }
