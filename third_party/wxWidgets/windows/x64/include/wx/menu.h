...
public:
    ...
    virtual wxMenuItem* Append(int itemid,
    ...
    virtual wxMenuItem* AppendSeparator() { return Append(wxID_SEPARATOR); }

    // append a check item
    virtual wxMenuItem* AppendCheckItem(int itemid,
                                const wxString& text,
                                const wxString& help = wxEmptyString)
    {
    ...
    // append a radio item
    virtual wxMenuItem* AppendRadioItem(int itemid,
                                const wxString& text,
                                const wxString& help = wxEmptyString)
    {
    ...
    // append a submenu
    virtual wxMenuItem* AppendSubMenu(wxMenu *submenu,
                              const wxString& text,
                              const wxString& help = wxEmptyString)
    {
    ...
    virtual wxMenuItem* Append(wxMenuItem *item) { return DoAppend(item); }
    ...
    virtual wxMenuItem* Insert(size_t pos, wxMenuItem *item);

    // insert an item before given position
    virtual wxMenuItem* Insert(size_t pos,
                       int itemid,
                       const wxString& text = wxEmptyString,
                       const wxString& help = wxEmptyString,
                       wxItemKind kind = wxITEM_NORMAL)
    ...
    // insert a separator
    virtual wxMenuItem* InsertSeparator(size_t pos)
    {
        return Insert(pos, wxMenuItem::New((wxMenu *)this, wxID_SEPARATOR));
    }

    // insert a check item
    virtual wxMenuItem* InsertCheckItem(size_t pos,
                                int itemid,
                                const wxString& text,
                                const wxString& help = wxEmptyString)
    {
    ...
    // insert a radio item
    virtual wxMenuItem* InsertRadioItem(size_t pos,
                                 int itemid,
                                 const wxString& text,
                                 const wxString& help = wxEmptyString)
    {
    ...
    virtual wxMenuItem* Prepend(wxMenuItem *item)
    {
        return Insert(0u, item);
    }

    // prepend any item to the menu
    virtual wxMenuItem* Prepend(int itemid,
                        const wxString& text = wxEmptyString,
                        const wxString& help = wxEmptyString,
                        wxItemKind kind = wxITEM_NORMAL)
    {
    ...
    // prepend a separator
    virtual wxMenuItem* PrependSeparator()
    {
        return InsertSeparator(0u);
    }

    // prepend a check item
    virtual wxMenuItem* PrependCheckItem(int itemid,
                                 const wxString& text,
                                 const wxString& help = wxEmptyString)
    {
    ...
    virtual wxMenuItem* PrependRadioItem(int itemid,
                                 const wxString& text,
                                 const wxString& help = wxEmptyString)
    {
    ...
    // deleting it!)
    virtual wxMenuItem *Remove(int itemid) { return Remove(FindChildItem(itemid)); }
    virtual wxMenuItem *Remove(wxMenuItem *item);

    // delete an item from the menu (submenus are not destroyed by this
    // function, see Destroy)
    virtual bool Delete(int itemid) { return Delete(FindChildItem(itemid)); }
    virtual bool Delete(wxMenuItem *item);

    // delete the item from menu and destroy it (if it's a submenu)
    virtual bool Destroy(int itemid) { return Destroy(FindChildItem(itemid)); }
    virtual bool Destroy(wxMenuItem *item);
