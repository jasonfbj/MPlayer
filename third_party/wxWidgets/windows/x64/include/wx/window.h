...
public:
    ...
    bool DestroyChildren();
        ...
        // return false that you want window destroied by parent.
    virtual bool AutoDestroyByParent()
    {
        return true;
    }

    virtual bool HasTouchEvent() const
    {
        return false;
    }

    inline static bool IsDPISupport()
    {
        return m_dpiSupportEnabled;
    }

    static void EnableDPISupport(bool enable = true)
    {
        m_dpiSupportEnabled = enable;
    }
    ...
    wxWindowVariant GetWindowVariant() const { return m_windowVariant; }
        ...
        // wxGTK emmit wxEVT_CREATE too later, we can do something early with override this function.
    virtual void PostCreation() {}

        // now, just windows implement raw touch events.
    virtual bool IsTouchScreenReady() const { return false; }
    virtual bool EnableRawTouchEvent() { return false; }
    ...
    bool HandleWindowEvent(wxEvent& event) const;
        ...
        // process wireless control key
        // if return true, it means 'skip'
    virtual bool ProcessWirelessControl(int key)
    {
        return true;
    }
...
protected:
    ...
    static bool                m_dpiSupportEnabled;
