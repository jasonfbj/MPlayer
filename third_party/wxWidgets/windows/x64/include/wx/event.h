...
class WXDLLIMPEXP_FWD_CORE wxDeviceChangedEvent;
...
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CORE, wxEVT_PRESS_AND_TAP, wxPressAndTapEvent);
    ...
    // Touch events.
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CORE, wxEVT_TOUCH, wxTouchEvent);
    // Device changed events.
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CORE, wxEVT_DEVICE_CHANGED, wxDeviceChangedEvent);
...
{
public:
    wxTouchEvent(wxWindowID winid = 0)
        : wxEvent(winid, wxEVT_TOUCH)
        { }
    wxTouchEvent(const wxTouchEvent& event)
        : wxEvent(event),
        m_infos(event.m_infos)
    { }
    void AppendTouchInfo(const wxTouchInfo& info)
    {
        m_infos.push_back(info);
    }

    wxVector<wxTouchInfo>& GetInfos()
    {
        return m_infos;
    }

    virtual wxEvent *Clone() const wxOVERRIDE { return new wxTouchEvent(*this); }

private:
    wxVector<wxTouchInfo>    m_infos;

    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN(wxTouchEvent);
};


/*
 wxEVT_DEVICE_CHANGED
 */
class WXDLLIMPEXP_CORE wxDeviceChangedEvent : public wxEvent
{
private:
    wxDECLARE_DYNAMIC_CLASS_NO_ASSIGN(wxDeviceChangedEvent);

public:
    wxDeviceChangedEvent()
        : wxEvent(0, wxEVT_DEVICE_CHANGED)
        { }

    virtual wxEvent *Clone() const wxOVERRIDE { return new wxDeviceChangedEvent(*this); }
};
...
public:
    ...
    bool IsUpwardDirection() const
        { return (m_flags & IsUpward);}

    bool IsDownwardDirection() const
        { return (m_flags & IsDownward);}
...
typedef void (wxEvtHandler::*wxDeviceChangedEventFunction)(wxDeviceChangedEvent&);
...
#define wxDeviceChangedEventHandler(func) \
    wxEVENT_HANDLER_CAST(wxDeviceChangedEventFunction, func)
...
#define EVT_DEVICE_CHANGED(func)  wx__DECLARE_EVT0(wxEVT_DEVICE_CHANGED, wxDeviceChangedEventHandler(func))
#define EVT_TOUCH(func)  wx__DECLARE_EVT0(wxEVT_TOUCH, wxTouchEventHandler(func))
