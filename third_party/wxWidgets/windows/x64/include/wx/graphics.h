...
public:
    ...
    static wxGraphicsContext* CreateFromARGB(unsigned char *argb, int width, int height);
    ...
    static void EnableHighQualityTextRender(bool enable);
...
protected:
    ...
    bool m_enableOffset;
    static bool m_highQualityTextRender;
...
public:
    ...
    static void SetUseD2DRenderDefault(bool enable);
    ...
    virtual wxGraphicsContext * CreateContextFromARGB(unsigned char *argb, int width, int height) { return nullptr; }
